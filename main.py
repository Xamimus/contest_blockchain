...
def run():
    ...
    time.sleep(0.8)
    saler2 = Wallet("14938570948877436095580126826539516641")
    wallet2 = Wallet(wallet.unique_id)
    print("Voici le nouveau solde du vendeur : " + str(saler2.balance))
    print("Et voici le votre : " + str(wallet2.balance))
    time.sleep(0.8)
    time.sleep(0.8)
